...
import dataclasses
import os
from typing import TYPE_CHECKING, Callable, NewType, NoReturn
...
class Bootstrapper(pydantic.BaseModel):
    ...
    use_orm: bool = pydantic.Field(default=False)
    orm_func: Callable[..., NoReturn] = pydantic.Field(default=None)
